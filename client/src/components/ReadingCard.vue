...
<template>
  <div
    class="bg-white dark:bg-stone-800 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 p-6 border-t-4 border-red-800 dark:border-red-600 relative overflow-hidden">
    ...
    <div v-if="hasParsedData" class="space-y-6">
      ...
      <div class="bg-stone-50 dark:bg-stone-900/50 p-4 rounded-lg border border-stone-100 dark:border-stone-700">
        ...
        <div v-if="fasting" class="mt-3 pt-3 border-t border-stone-200 dark:border-stone-700 flex items-start gap-2">
          ...
          <div>
            <span
              class="text-xs font-bold uppercase tracking-wider text-stone-500 dark:text-stone-400 block mb-0.5">Fasting</span>
